import { navigationState as e } from "../utils.js";
export const navbarShrink = {
  ...
  shrink() {
    ...
    !this.isnavbarShrink && e > this.navbarHeight
      ? ((this.isnavbarShrink = !0),
        document.body.classList.add("navbar-shrink"))
      : this.isnavbarShrink &&
        e <= this.navbarHeight &&
        ((this.isnavbarShrink = !1),
  ...
  togglenavbarDrawerShow() {
    ...
    document.querySelector(".navbar-drawer") &&
      e.push(
      ...
      e.forEach((e) => {
        e.dataset.navbarInitialized ||
          ((e.dataset.navbarInitialized = 1),
    ...
    t &&
      !t.dataset.navbarInitialized &&
      ((t.dataset.navbarInitialized = 1),
      t.addEventListener("click", () => {
        document.body.classList.remove("navbar-drawer-show");
      }));
  },
  toggleSubmenu() {
    document.querySelectorAll("[navbar-data-toggle]").forEach((e) => {
      e.dataset.eventListenerAdded ||
        ((e.dataset.eventListenerAdded = "true"),
        e.addEventListener("click", function () {
          const e = document.querySelector(
              '[data-target="' + this.getAttribute("navbar-data-toggle") + '"]',
            ),
            t = e.children,
            a = this.querySelector(".fa-chevron-right");
          if (e) {
            const n = !e.classList.contains("hidden");
            a && a.classList.toggle("icon-rotated", !n),
              n
                ? anime({
                    targets: t,
                    opacity: 0,
...
try {
  swup.hooks.on("page:view", () => {
    navbarShrink.init(), (e.isNavigating = !1);
  }),
    swup.hooks.on("visit:start", () => {
      (e.isNavigating = !0), document.body.classList.remove("navbar-shrink");
    });
} catch (e) {}
