...
export function initTocToggle() {
  const t = {
    ...
    toggleClassName(e, t, o) {
      e && e.classList.toggle(t, o);
    },
    changePageLayoutWhenOpenToggle(e) {
      this.toggleClassName(this.toggleBarIcon, "fas", e),
        this.toggleClassName(this.toggleBarIcon, "fa-indent", e),
        this.toggleClassName(this.toggleBarIcon, "fa-outdent", !e),
        this.toggleClassName(this.postPageContainerDom, "show-toc", e),
        this.toggleClassName(this.mainContentDom, "has-toc", e);
    },
    pageAsideHandleOfTOC(e) {
      (this.toggleBar.style.display = "flex"),
        (this.isOpenPageAside = e),
        this.changePageLayoutWhenOpenToggle(e);
    },
  };
  return t.initToggleBarButton(), t;
}
try {
