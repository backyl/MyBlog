...
var bl = (e, t, i) =>
  t in e
    ? yl(e, t, { enumerable: !0, configurable: !0, writable: !0, value: i })
    : (e[t] = i);
var Oe = (e, t, i) => (bl(e, typeof t != "symbol" ? t + "" : t, i), i),
  _l = (e, t, i) => {
...
var xn, kr, yi, wl;
const Ir = { "Content-Type": "application/json" },
  Ge = (e) => `${e.replace(/\/?$/, "/")}api/`,
  vt = (e, t = "") => {
  ...
  ki = ({ serverURL: e, lang: t, paths: i, type: n, signal: r }) =>
    fetch(
      `${Ge(e)}article?path=${encodeURIComponent(i.join(","))}&type=${encodeURIComponent(n.join(","))}&lang=${t}`,
      { signal: r },
    )
      .then((o) => o.json())
      .then((o) => vt(o, "Get counter").data),
  In = ({ serverURL: e, lang: t, path: i, type: n, action: r }) =>
  ...
  Sr = ({
    ...
    return (
      ...
      fetch(
        `${Ge(e)}comment?path=${encodeURIComponent(i)}&pageSize=${r}&page=${n}&lang=${t}&sortBy=${o}`,
        { signal: s, headers: a },
      )
        .then((c) => c.json())
  ...
  Lr = ({ serverURL: e, lang: t, paths: i, signal: n }) =>
    fetch(
      `${Ge(e)}comment?type=count&url=${encodeURIComponent(i.join(","))}&lang=${t}`,
      { signal: n },
    )
      .then((r) => r.json())
  ...
  Il = (e) => {
    const t = async (i, n = {}) =>
      fetch(
        `https://api.giphy.com/v1/gifs/${i}?${new URLSearchParams({ lang: e, limit: "20", rating: "g", api_key: "6CIMLkNMMOhRcXPoMCPkFy4Ybk2XUiMp", ...n }).toString()}`,
      )
        .then((r) => r.json())
        .then(({ data: r }) =>
          r.map((o) => ({
  ...
  Ll = /\/\*([\S\s]*?)\*\//gm,
  Al = new RegExp(
    `(${Sl.source}|${Rl.source})|((?:${Tl.source})|(?:${Ll.source}))`,
    "gmi",
  ),
  Ur = [
    "23AC69",
...
const Wr = "en-US",
  ...
  qr = (e) => Sn[e.toLowerCase()] || Sn[Wr],
  zl = (e) => (Object.keys(Sn).includes(e.toLowerCase()) ? e : Wr),
  Kr = (e) => {
    try {
      e = decodeURI(e);
    } catch {}
...
const Q = (e) =>
    ve(e)
      ...
      : e == null
        ? ""
        : N(e) || (ce(e) && (e.toString === Xr || !ee(e.toString)))
...
class Oi {
  ...
  stop() {
    this.active &&
      (so(this), lo(this), this.onStop && this.onStop(), (this.active = !1));
  }
}
function so(e) {
    ...
    n._dirtyLevel < t &&
      ...
      n._shouldSchedule &&
        ...
        (!n._runnings || n.allowRecurse) &&
          n._dirtyLevel !== 2 &&
          ((n._shouldSchedule = !1), n.scheduler && Ui.push(n.scheduler)));
  }
  Pi();
}
const ho = (e, t) => {
...
class mo {
  ...
  get(t, i, n) {
    ...
    if (i === "__v_raw")
      return n === (r ? (o ? ba : Co) : o ? xo : ko).get(t) ||
    ...
    return (Qe(i) ? po.has(i) : oa(i)) || (r || Se(t, "get", i), o)
      ? l
      : Re(l)
        ? s && Ti(i)
          ? l
...
class vo extends mo {
  ...
  set(t, i, n, r) {
    ...
    return (
      t === J(r) && (s ? lt(n, o) && Je(t, "set", i, n) : Je(t, "add", i, n)), l
    );
  }
  deleteProperty(t, i) {
    const n = G(t, i),
...
function zn(e, t = !1) {
  const i = this.__v_raw,
    ...
    r = J(e);
  return (
    t || (lt(e, r) && Se(n, "has", e), Se(n, "has", r)),
    e === r ? i.has(e) : i.has(e) || i.has(r)
  );
}
function Pn(e, t = !1) {
  return (
    (e = e.__v_raw), !t && Se(J(e), "iterate", kt), Reflect.get(e, "size", e)
  );
}
function wo(e) {
  e = J(e);
...
function yo(e, t) {
  ...
  const s = r.call(i, e);
  return (
    i.set(e, t), o ? lt(t, s) && Je(i, "set", e, t) : Je(i, "add", e, t), this
  );
}
function bo(e) {
  const t = J(this),
...
function Un(e, t) {
  return function (n, r) {
    const o = this,
      ...
      a = t ? Hi : e ? Bi : en;
    return (
      !e && Se(l, "iterate", kt), s.forEach((c, f) => n.call(r, a(c), a(f), o))
    );
  };
}
function Fn(e, t, i) {
...
function So(e) {
  ...
  at &&
    ...
    uo(
      ...
      (t = e.dep) != null
        ? t
        : (e.dep = ho(() => (e.dep = void 0), e instanceof Io ? e : void 0)),
    ));
}
function Hn(e, t = 4, i) {
  e = J(e);
...
function Ki(e) {
  (!be.length || !be.includes(e, tn && e.allowRecurse ? We + 1 : We)) &&
    (e.id == null ? be.push(e) : be.splice(La(e.id), 0, e), Mo());
}
function Mo() {
...
function Ma(e) {
  N(e)
    ? Ut.push(...e)
    : (!ft || !ft.includes(e, e.allowRecurse ? xt + 1 : xt)) && Ut.push(e),
    Mo();
}
...
function ja(e, t, i = !1) {
  ...
  return !o && !!1
    ...
    : (N(o) ? o.forEach((a) => (s[a] = null)) : ye(s, o),
      ce(e) && n.set(e, s),
      s);
}
function Vn(e, t) {
...
function Gi(e) {
  ...
  try {
    if (i.shapeFlag & 4) {
      ...
      const F = t;
      ($ = qe(
        F.length > 1 ? F(h, { attrs: l, slots: s, emit: a }) : F(h, null),
      )),
        (P = t.props ? l : Pa(l));
    }
  } catch (F) {
  ...
  if (P && x !== !1) {
    ...
    F.length &&
      X & 7 &&
      (o && F.some(Ri) && (P = Ua(P, o)), (A = Nt(A, P, !1, !0)));
  }
  return (
    i.dirs &&
      ((A = Nt(A, null, !1, !0)),
  ...
  return (
    l
      ...
      : !r.length && !i && !n
        ? (a = t)
        : ((a = {}),
          r.length && r.forEach((c) => Gn(a, c, s, !0)),
          Gn(a, t, s)),
    ce(t) && o.set(t, a),
    a
  );
...
function Bo(e, t) {
  return e
    ? N(e) && N(t)
      ? [...new Set([...e, ...t])]
      : ye(Object.create(null), Ho(e), Ho(t ?? {}))
    : t;
}
function nc(e, t) {
  if (!e) return t;
...
const qo = {},
  Ko = () => Object.create(qo),
  Go = (e) => Object.getPrototypeOf(e) === qo;
...
function ac(e, t, i = !1) {
  ...
  if (N(o))
    ...
    for (const f in o) {
      ...
      if (Qo(h)) {
        const p = o[f],
          g = (s[h] = N(p) || ee(p) ? { type: p } : ye({}, p));
        if (g) {
          const R = Xo(Boolean, g.type),
            x = Xo(String, g.type);
          (g[0] = R > -1),
            (g[1] = x < 0 || R < x),
...
function pc(e, t) {
  ...
  const {
    ...
    x = (
      ...
      if (u === d) return;
      u && !fn(u, d) && ((w = mt(u)), Ie(u, v, b, !0), (u = null)),
        ...
        default:
          z & 1
            ...
            : z & 6
              ...
              : (z & 64 || z & 128) && y.process(u, d, m, w, v, b, C, _, k, ot);
      }
    ...
    X = (u, d, m, w, v, b, C, _, k) => {
      d.type === "svg" ? (C = "svg") : d.type === "math" && (C = "mathml"),
        u == null ? H(d, m, w, v, b, C, _, k) : Le(u, d, v, b, C, _, k);
    },
    H = (u, d, m, w, v, b, C, _) => {
      let k, y;
      const { props: S, shapeFlag: z, transition: E, dirs: U } = u;
      if (
        ((k = u.el = s(u.type, b, S && S.is, S)),
        z & 8
          ? f(k, u.children)
          : z & 16 && V(u.children, k, null, w, v, nr(u, b), C, _),
        U && Et(u, null, w, "created"),
        D(k, u, u.scopeId, C, w),
        S)
      ) {
        for (const ne in S)
          ne !== "value" &&
            !Gt(ne) &&
            o(k, ne, null, S[ne], b, u.children, w, v, Fe);
        "value" in S && o(k, "value", null, S.value, b),
          (y = S.onVnodeBeforeMount) && Ke(y, w, u);
      }
      U && Et(u, null, w, "beforeMount");
      const K = gc(v, E);
      K && E.beforeEnter(k),
        n(k, d, m),
        ((y = S && S.onVnodeMounted) || K || U) &&
          Te(() => {
    ...
    Le = (u, d, m, w, v, b, C) => {
      ...
      if (
        (m && It(m, !1),
        (U = E.onVnodeBeforeUpdate) && Ke(U, m, d, u),
        S && Et(d, u, m, "beforeUpdate"),
        m && It(m, !0),
        y
          ? B(u.dynamicChildren, y, _, m, w, nr(d, v), b)
          : C || _e(u, d, _, null, m, w, nr(d, v), b, !1),
        k > 0)
      ) {
    ...
    B = (u, d, m, w, v, b, C) => {
      for (let _ = 0; _ < d.length; _++) {
        const k = u[_],
          y = d[_],
          S =
            k.el && (k.type === oe || !fn(k, y) || k.shapeFlag & 70)
              ? h(k.el)
              : m;
    ...
    le = (u, d, m, w, v, b, C) => {
      if (m !== w) {
        if (m !== se)
          for (const _ in m)
            !Gt(_) && !(_ in w) && o(u, _, m[_], null, C, d.children, v, b, Fe);
        for (const _ in w) {
          if (Gt(_)) continue;
          const k = w[_],
            y = m[_];
    ...
    fe = (u, d, m, w, v, b, C, _, k) => {
      ...
      U && (_ = _ ? _.concat(U) : U),
        u == null
          ? (n(y, m, w), n(S, m, w), V(d.children || [], m, S, v, b, C, _, k))
          : z > 0 && z & 64 && E && u.dynamicChildren
            ? (B(u.dynamicChildren, E, m, v, b, C, _),
              (d.key != null || (v && d === v.subTree)) && is(u, d, !0))
            : _e(u, d, m, S, v, b, C, _, k);
    },
    rt = (u, d, m, w, v, b, C, _, k) => {
      (d.slotScopeIds = _),
        u == null
      ...
      const _ = () => {
          if (u.isMounted) {
            ...
            let ne = S,
              ae;
            It(u, !1),
              S ? ((S.el = K.el), de(u, S, C)) : (S = K),
              z && Mn(z),
              (ae = S.props && S.props.onVnodeBeforeUpdate) && Ke(ae, U, S, K),
              It(u, !0);
            const me = Gi(u),
              Ne = u.subTree;
            (u.subTree = me),
              x(Ne, me, h(Ne.el), mt(Ne), u, v, b),
              (S.el = me.el),
              ne === null && Na(u, me.el),
              E && Te(E, v),
            ...
            const { el: z, props: E } = d,
              { bm: U, m: K, parent: ne } = u,
              ae = Kn(d);
            if (
              (It(u, !1),
              U && Mn(U),
              !ae && (S = E && E.onVnodeBeforeMount) && Ke(S, ne, d),
              It(u, !0),
              z && j)
            ) {
              const me = () => {
        ...
        k = (u.effect = new Oi(_, Ze, () => Ki(y), u.scope)),
        y = (u.update = () => {
          k.dirty && k.run();
        });
      (y.id = u.uid), It(u, !0), y();
    ...
    _e = (u, d, m, w, v, b, C, _, k = !1) => {
      ...
      U & 8
        ? (S & 16 && Fe(y, v, b), z !== y && f(m, z))
        : S & 16
          ? U & 16
            ? ke(y, z, m, w, v, b, C, _, k)
            : Fe(y, v, b, !0)
          : (S & 8 && f(m, ""), U & 16 && V(z, m, w, v, b, C, _, k));
    },
    ...
    ke = (u, d, m, w, v, b, C, _, k) => {
      ...
      for (; y <= z && y <= E; ) {
        const U = u[y],
          K = (d[y] = k ? dt(d[y]) : qe(d[y]));
        if (fn(U, K)) x(U, K, m, null, v, b, C, _, k);
        else break;
        y++;
      }
      for (; y <= z && y <= E; ) {
      ...
      if (y > z) {
        if (y <= E) {
          const U = E + 1,
            K = U < S ? d[U].el : w;
          for (; y <= E; )
            x(null, (d[y] = k ? dt(d[y]) : qe(d[y])), m, K, v, b, C, _, k), y++;
        }
      } else if (y > E) for (; y <= z; ) Ie(u[y], v, b, !0), y++;
      else {
        const U = y,
          K = y,
          ne = new Map();
        ...
        for (ae = Cr.length - 1, y = Ne - 1; y >= 0; y--) {
          const Ae = K + y,
            De = d[Ae],
            Er = Ae + 1 < S ? d[Ae + 1].el : w;
          Wt[y] === 0
            ? x(null, De, m, Er, v, b, C, _, k)
            : Mt && (ae < 0 || y !== Cr[ae] ? ge(De, m, Er, 2) : ae--);
        }
      }
    },
    ge = (u, d, m, w, v = null) => {
      ...
      if (w !== 2 && y & 1 && _)
        if (w === 0) _.beforeEnter(b), n(b, d, m), Te(() => _.enter(b), v);
        else {
          const { leave: z, delayLeave: E, afterLeave: U } = _,
            K = () => n(b, d, m),
            ne = () => {
              z(b, () => {
                K(), U && U();
    ...
    Ie = (u, d, m, w = !1, v = !1) => {
      ...
      const U = S & 1 && E,
        K = !Kn(u);
      let ne;
      if ((K && (ne = C && C.onVnodeBeforeUnmount) && Ke(ne, d, u), S & 6))
        bi(u.component, m, w);
      else {
        if (S & 128) {
        ...
        U && Et(u, null, d, "beforeUnmount"),
          S & 64
            ? u.type.remove(u, d, m, v, ot, w)
            : y && (b !== oe || (z > 0 && z & 64))
              ? Fe(y, d, m, !1, !0)
              : ((b === oe && z & 384) || (!v && S & 16)) && Fe(k, d, m),
          w && Lt(u);
      }
      ((K && (ne = C && C.onVnodeUnmounted)) || U) &&
        Te(() => {
...
function yc(e, t = null, i = null, n = 0, r = null, o = !1) {
  ...
  if ((Lc(e) && (e = e.__vccOpts), t)) {
    ...
    l && !ve(l) && (t.class = pe(l)),
      ce(a) && (Eo(a) && !N(a) && (a = ye({}, a)), (t.style = Zt(a)));
  }
...
function or(e, t) {
  ...
  if (t == null) t = null;
    ...
    ee(t)
      ...
      : ((t = String(t)), n & 64 ? ((i = 16), (t = [Xe(t)])) : (i = 8));
...
function Ic(e, t) {
  ...
  const { setup: n } = i;
  if (n) {
    const r = (e.setupContext = n.length > 1 ? Rc(e) : null),
      o = lr(e);
    bt();
    ...
    if (!t && ds && !n.render) {
      ...
      if (r) {
        const { isCustomElement: o, compilerOptions: s } = e.appContext.config,
          ...
          c = ye(ye({ isCustomElement: o, delimiters: l }, s), a);
        n.render = ds(r, c);
      }
    }
...
function ei(e) {
  if (e.exposed)
    return (
      e.exposeProxy ||
      (e.exposeProxy = new Proxy(Lo(Ca(e.exposed)), {
        get(t, i) {
...
const qc = Promise.resolve(),
  Kc = () => cr || (qc.then(() => (cr = 0)), (cr = Date.now()));
function Gc(e, t) {
  const i = (n) => {
  ...
  ur = {
    created(e, { modifiers: { lazy: t, trim: i, number: n } }, r) {
      ...
      et(e, t ? "change" : "input", (s) => {
        ...
        t ||
          (et(e, "compositionstart", Yc),
          et(e, "compositionend", xs),
          et(e, "change", xs));
    },
    mounted(e, { value: t }) {
      e.value = t ?? "";
...
function gu(e, t, i = {}) {
  const { eventFilter: n, ...r } = i,
    { eventFilter: o, pause: s, resume: l, isActive: a } = du(n);
  return {
    stop: pu(e, t, { ...r, eventFilter: o }),
    pause: s,
    resume: l,
    isActive: a,
  };
...
function Dt(e, t, i, n = {}) {
  ...
  const {
    ...
    x = (f ? Ia : W)(typeof t == "function" ? t() : t);
  if (!i)
    try {
  ...
  const T = tt(t),
    $ = xu(T),
    P = (r = n.serializer) != null ? r : Cu[$],
    { pause: A, resume: F } = gu(x, () => H(x.value), {
      flush: o,
      deep: s,
      eventFilter: p,
    });
...
function Iu(e, t = oi, i = {}) {
  ...
  const x = (P) =>
      new Promise((A, F) => {
        ...
        let H = !1,
          D = h.querySelector(`script[src="${tt(e)}"]`);
        D
          ...
          : ((D = h.createElement("script")),
            ...
            (H = !0)),
          D.addEventListener("error", (V) => F(V)),
          D.addEventListener("abort", (V) => F(V)),
...
const Tu = (e) => !!/@[0-9]+\.[0-9]+\.[0-9]+/.test(e),
  ...
  $s = (e, t = "", i = "", n = "") =>
    `${t ? `${t}/` : ""}${i}${e}${n ? `.${n}` : ""}`,
  Au = (e) =>
    Promise.all(e.map((t) => ($t(t) ? Lu(Gr(t)) : Promise.resolve(t)))).then(
      (t) => {
        const i = { tabs: [], map: {} };
        return (
          t.forEach((n) => {
...
const Ps = /[&<>"']/,
  $u = new RegExp(Ps.source, "g"),
  Us = /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,
  Ou = new RegExp(Us.source, "g"),
  ju = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" },
  Fs = (e) => ju[e];
function $e(e, t) {
  if (t) {
...
`,
            ...
            if (
              ...
              this.options.pedantic &&
                (p = p.replace(/^ {1,4}(?=( {4})*[^ ])/g, "  ")),
              A.test(p) || F.test(p) || $.test(p) || P.test(t))
            )
              break;
...
const Hu = /^(?: *(?:\n|$))+/,
  ...
  pi = { normal: vr, gfm: Qu, pedantic: Ju },
  vn = { normal: wr, gfm: yr, breaks: hf, pedantic: df };
class nt {
  tokens;
  options;
  state;
      ...
      switch (o.type) {
        ...
        case "heading": {
          ...
          n += this.renderer.heading(
            ...
            s.depth,
            Pu(this.parseInline(s.tokens, this.textRenderer)),
          );
          continue;
        }
        case "code": {
...
class Js {
  constructor(...t) {
    ...
    Oe(
      this,
      "parseInline",
      En(this, xn, kr).call(this, nt.lexInline, it.parseInline),
    );
    Oe(this, "Parser", it);
    Oe(this, "Renderer", gi);
...
const el = /[&<>"']/,
  gf = new RegExp(el.source, "g"),
  tl = /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,
  mf = new RegExp(tl.source, "g"),
  vf = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" },
  nl = (e) => vf[e];
function il(e, t) {
  if (t) {
...
const wf = /\$.*?\$/,
    ...
    return (
      (((t = xf(e)) == null
        ...
        : t.reduce(
            ...
            0,
          )) ?? 0) + (((i = Cf(e)) == null ? void 0 : i.length) ?? 0)
    );
  },
  If = async () => {
    if (!navigator) return "";
  ...
  Ff = () => Dt("WALINE_COMMENT_BOX_EDITOR", ""),
  Nf = "WALINE_LIKE";
let sl = null;
const ll = () => sl ?? (sl = Dt(Nf, [])),
  Hf = "WALINE_REACTION";
let al = null;
...
const Jf = { key: 0, class: "wl-reaction" },
  Yf = ["textContent"],
  Xf = { class: "wl-reaction-list" },
  ed = ["onClick"],
  td = { class: "wl-reaction-img" },
  nd = ["src", "alt"],
  id = ["textContent"],
  rd = ["textContent"];
                ...
                if (
                  ...
                  $ &&
                    ((p = (function (F) {
                      for (
                        var X = [];
                        F && F.parentNode && F.parentNode instanceof Element;

                      )
                        F.parentNode.scrollTop &&
                          X.push([F.parentNode, F.parentNode.scrollTop]),
                          (F = F.parentNode);
                      return function () {
...
![${O.name}](${u})`,
        ...
        Lt = async () => {
          ...
          if ((O = a.value) != null && O.token && !n.edit)
            ...
            if (k.indexOf("nick") > -1 && !E.nick)
              return (
                ...
                alert(Ue.value.nickError)
              );
            if ((k.indexOf("mail") > -1 && !E.mail) || (E.mail && !Vl(E.mail)))
              return (
                (u = c.value.mail) == null || u.focus(),
                alert(Ue.value.mailError)
              );
          ...
          (E.comment = rl(E.comment, $.value.map)),
            ...
            (fe.value = !0);
          try {
            y && (E.recaptchaV3 = await Kf(y).execute("social")),
              S && (E.turnstile = await Gf(S).execute("social"));
            const U = {
                serverURL: v,
                lang: b,
        ...
        Fe = (O) => {
          ...
          const { lang: j, serverURL: u } = o.value,
            ...
            b = new URLSearchParams({ lng: j, token: a.value.token }),
            C = window.open(
              `${u}/ui/profile?${b.toString()}`,
              "_blank",
        ...
        li("message", ({ data: O }) => {
          ...
          (a.value = { ...a.value, ...O.data }),
            [localStorage, sessionStorage]
              .filter((d) => d.getItem("WALINE_USER"))
              .forEach((d) => d.setItem("WALINE_USER", JSON.stringify(a)));
          const u = as();
      ...
      return (
        Object.defineProperty(ot, "__isScriptSetup", {
          enumerable: !1,
          value: !0,
        }),
        ot
...
const gd = { class: "wl-comment" },
  md = { key: 0, class: "wl-login-info" },
  vd = { class: "wl-avatar" },
  wd = ["title"],
  yd = ["title"],
  bd = ["src"],
            ...
            n.config.login !== "force" || n.isLogin
              ? (I(),
                L(
                  ...
                  [
                    n.isSubmitting
                      ? (I(), Ye(n.LoadingIcon, { key: 0, size: 16 }))
                      : (I(),
                        L(oe, { key: 1 }, [Xe(Q(n.locale.submit), 1)], 64)),
                  ],
                  8,
                  Dd,
                ))
          ...
          M(
            ...
            [
              ...
              n.searchResults.loading
                ? (I(), L("div", Bd, [ie(n.LoadingIcon, { size: 30 })]))
                : Z("v-if", !0),
            ],
            2,
          ),
        ...
        M("div", ih, [
          M("div", rh, [
            n.link
              ...
              : (I(), L("span", sh, Q(i.comment.nick), 1)),
            ...
            M("div", dh, [
              ...
              M(
                ...
                [
                  ...
                  Xe(" " + Q("like" in i.comment ? i.comment.like : ""), 1),
                ],
                8,
                hh,
              ),
    ...
    const A = (q) => {
      ...
      fe = async ({ objectId: q }) => {
        ...
        await Tr({
          ...
          g.value.some((he, ke) =>
            he.objectId === q
              ? ((g.value = g.value.filter((ge, Ie) => Ie !== ke)), !0)
              : he.children.some((ge, Ie) =>
                  ge.objectId === q
  ...
  return (
    ...
    L("div", Th, [
      ...
      n.reply
        ? Z("v-if", !0)
        : (I(),
          Ye(n.CommentBox, { key: 0, onLog: n.refresh, onSubmit: n.onSubmit })),
      M("div", Lh, [
        M("div", Ah, [
          n.count
            ? (I(),
      ...
      n.status === "error"
        ...
        : n.status === "loading"
          ? (I(), L("div", Uh, [ie(n.LoadingIcon, { size: 30 })]))
          : n.data.length
            ? n.page < n.totalPages
              ? (I(),
                L("div", Nh, [
      ...
      n.config.copyright
        ? (I(),
          L("div", Dh, [Xe(" Powered by "), Vh, Xe(" v" + Q(n.version), 1)]))
        : Z("v-if", !0),
    ])
  );
}
...
const ml = (e, t) => {
  ...
  Kh = ({ el: e, serverURL: t, count: i, lang: n = navigator.language }) => {
    ...
    return Or({
      ...
      s && a.length
        ? ((s.innerHTML = `<ul class="wl-recent-list">${a.map((c) => `<li class="wl-recent-item"><a href="${c.url}">${c.nick}</a>：${c.comment}</li>`).join("")}</ul>`),
          {
            comments: a,
            destroy: () => {
              l.abort(), (s.innerHTML = "");
