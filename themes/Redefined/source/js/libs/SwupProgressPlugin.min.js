!(function (t, e) {
  ...
  class s {
    ...
    on(t, e, s = {}) {
      var i;
      e =
        !(i = e).name.startsWith("bound ") || i.hasOwnProperty("prototype")
          ? e.bind(this)
          : e;
    ...
    once(e, s, i = {}) {
      return this.on(e, s, t({}, i, { once: !0 }));
    }
    before(e, s, i = {}) {
      return this.on(e, s, t({}, i, { before: !0 }));
    }
    replace(e, s, i = {}) {
      return this.on(e, s, t({}, i, { replace: !0 }));
    }
    off(t, e) {
  ...
  class i {
    constructor(t) {
      ...
      (this.value = 0),
        ...
        void 0 !== e && (this.className = String(e)),
        void 0 !== s && (this.styleAttr = String(s)),
        void 0 !== i && (this.animationDuration = Number(i)),
        void 0 !== r && (this.minValue = Number(r)),
        void 0 !== n && (this.initialValue = Number(n)),
